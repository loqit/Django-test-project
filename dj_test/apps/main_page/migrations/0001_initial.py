# Generated by Django 3.0.3 on 2020-02-15 23:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('com_date', models.DateTimeField(verbose_name='date')),
                ('author_name', models.CharField(max_length=50, verbose_name='name')),
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_page.Article')),
            ],
        ),
    ]
